...
class App(tk.Tk): 
    ...
    def __init__(self):
        ...
        # self.iconbitmap("imagens/python_icon.ico") 
...
# input Nome
        ...
        self.txtNome.grid(row=1, column=1, sticky="w", padx=20, pady=5)
        self.txtNome.focus()
...
# label e-mail
        ...
        # chamada e posicionamento do label 
...
# input e-mail
        ...
        self.txtEmail.grid(row=2, column=1, sticky="w", padx=20, pady=5)
...
# Botões
        ...
        self.btnCreate.grid(row=3, column=2, sticky="nwes", padx=20, pady=5, ipadx=20)

        self.btnRead = ttk.Button(
            self, text="Read",
            command=self.btnListar_Click
        )
        self.btnRead.grid(row=4, column=2, sticky="nwes", padx=20, pady=5, ipadx=20)

        self.btnUpdate = ttk.Button(
            self, text="Update",
            command=self.btnUpdate_Click
        )
        self.btnUpdate.grid(row=5, column=2, sticky="nwes", padx=20, pady=5, ipadx=20)

        self.btnDelete = ttk.Button(
            self, text="Delete",
            command=self.btnDelete_Click
        )
        self.btnDelete.grid(row=6, column=2, sticky="nwes", padx=20, pady=5, ipadx=20)
    ...
    def btnConectar_Click(self):
        try: 
            ...
            sql = "CREATE DATABASE IF NOT EXISTS crud_database"
    ...
    def btnInserir_Click(self):
        ...
        if reNome is None:
            ...
            try:
                ...
                self.varEmail.set("")
                self.txtNome.focus()
                # Pendente: Mostrar os registros na lista
                self.btnListar_Click()
    ...
    def btnDelete_Click(self):        
        ...
        try: 
            ...
            self.varResultado.set("Registro excluído com sucesso!!")
            self.lblResultado.configure(background="#3cb371")
